...
var isForApple = aThroughD.splice(0,1);
//isForApple.push(aThroughD.splice(0,1));
isForApple = isForApple[0];

//6. Add 'e' to the end of aThroughD.
var eEnd = aThroughD.push('e');

//7. Add 'apple' to the beginning of aThroughD
var aAt = aThroughD.unshift('apple');
